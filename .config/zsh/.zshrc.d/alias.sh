...
alias v='lvim'
alias vim='lvim'
alias vzh='lvim $XDG_CONFIG_HOME/zsh/.zshrc'
alias vtm='lvim ~/.tmux.conf'
alias szh='source $XDG_CONFIG_HOME/zsh/.zshrc'
alias vvm='lvim ~/.vimrc'
...
# gpg
alias gpgsec='gpg --export-secret-keys >~/.gnupg/secring.gpg'
